...
APGWall_Brown::APGWall_Brown()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> MaterialRef(TEXT("/Game/Imports/SICKA_mansion/Materials/MI_WallSet.MI_WallSet"));

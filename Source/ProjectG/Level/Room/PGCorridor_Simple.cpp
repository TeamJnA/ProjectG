...
APGCorridor_Simple::APGCorridor_Simple()
{
	static ConstructorHelpers::FClassFinder<AActor> RoomMeshRef(TEXT("/Game/ProjectG/Levels/Room/LevelInstance/LI_MansionCorridor_Simple.LI_MansionCorridor_Simple_C"));
	...
	OverlapBox->SetRelativeLocation(FVector(1810.0f, 0.0f, 315.0f));
	OverlapBox->SetRelativeScale3D(FVector(55.75f, 9.6f, 9.75f));

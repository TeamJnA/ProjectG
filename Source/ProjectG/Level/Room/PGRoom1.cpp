...
APGRoom1::APGRoom1()
{
	...
	ExitDir2->SetRelativeLocation(FVector(3613.4f, -0.1f, 0.0f));
	...
	*/
	...
	MannequinSpawnPoint0->SetRelativeLocation(FVector(650.0f, 280.0f, 6.0f));
	...
	OverlapBox->SetRelativeScale3D(FVector(55.8f, 12.0f, 9.25f));
	...
	Mesh->SetRelativeLocation(FVector(1847.4f, 63.0f, -49.1f));

...
APGStartRoom::APGStartRoom()
{
	...
	ExitDir0->SetRelativeLocation(FVector(945.3f, -1215.9f, 414.0f));
	...
	ExitDir1->SetRelativeLocation(FVector(1885.3f, 319.8f, 414.0f));
	...
	OverlapBox->SetRelativeLocation(FVector(945.0f, 0.0f, 500.0f));

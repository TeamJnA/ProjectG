...
APGRoom4::APGRoom4()
{
	...
	ExitDir0->SetRelativeLocation(FVector(990.0f, 990.0f, 0.0f));
	ExitDir0->SetRelativeRotation(FRotator(0.0f, 90.f, 0.0f));
	...
	Mesh4->SetRelativeLocation(FVector(1640.0f, 950.0f, 100.0f));
	...
	Mesh5->SetRelativeLocation(FVector(340.0f, 950.0f, 100.0f));
